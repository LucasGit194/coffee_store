...
TABLES['Order_items'] = ('''
        ...
        drinks_id INT NOT NULL PRIMARY KEY,
...
drinks = [
    ...
    ("CAPPUCCINO", "10.00", "250", "Steamed Milk + 1 Shot of Expresso"),
    ("LATTE", "15.00", "200", "Milk foam + Steamed Milk + 1 Shot of Expresso"),
    ("ICED COFFEE", "15.00", "200", "Ice + Milk + 1 Shot of Expresso"),
    ("BLACK EYE", "10.00", "50", "Brewed Coffee + 1 Shot of Expresso"),
    ("FLAT WHITE", "10.00", "150", "Steamed Milk + Double Expresso"),
    ("FRAPPE", "20.00", "150", "Ice Cream + Steamed Milk + 1 Shot of Expresso"),
    ("IRISH COFFEE", "25.00", "50", "Whipped Cream + Whiskey + 1 Shot of Expresso")
]
images = []
